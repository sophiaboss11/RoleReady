-- =============================================================
-- Align legacy training assignment completion with per-user
-- module completion across the full module list.
--
-- Progress and completion should reflect:
--   completed modules / total modules
-- not aggregate learner progress and not required-only counts.
-- =============================================================
